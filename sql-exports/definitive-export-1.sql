...
# Generation time: 2024-07-24T18:02:02-03:00
# ************************************************************
...
CREATE TABLE `horario_materia` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK5gb795pf1ovp0e6ugrx4i6p96` (`id_materia`),
  CONSTRAINT `FK5gb795pf1ovp0e6ugrx4i6p96` FOREIGN KEY (`id_materia`) REFERENCES `materias` (`id`)
...
CREATE TABLE `materias` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK4v0qnn1p6ccgg1cc2e3a63xqw` (`id_curso`),
  KEY `FKoir1beohjrum711we2vanykjh` (`id_user`),
  CONSTRAINT `FK4v0qnn1p6ccgg1cc2e3a63xqw` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id`),
  CONSTRAINT `FKoir1beohjrum711we2vanykjh` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`),
  CONSTRAINT `materias_chk_1` CHECK ((`dia` between 0 and 6))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
# Dump completed on 2024-07-24T18:02:02-03:00
