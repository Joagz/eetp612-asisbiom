...
# Generation time: 2024-08-19T22:10:39-03:00
# ************************************************************
...
INSERT INTO `users` (`id`, `dni`, `email`, `nombre_completo`, `phone`, `pwd`, `role`, `finger_id`) VALUES
	...
	(10, NULL, "sensor 2", NULL, "", "$2a$10$fOMmACGryv3kX7jvCjiJluhksyRudKq6EaWawnx4BU9Y7Zk451PTC", "USUARIO", NULL),
	(11, "", "sensor 2!!", "", "", "$2a$10$36v7PNNgOy4O.MNAtAzYKu89sH0LYEIq.pH.vTrADD/nzDPMs4fRe", "SENSOR", NULL),
	(12, "", "montalvito", "", "", "$2a$10$uD/nGTuCglq56972P6e/5e.6pU0pUEbN3SH4jLgakNtOxkxC2Vny.", "SENSOR", NULL);
...
# Dump completed on 2024-08-19T22:10:39-03:00
